            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown" id="shop-dropdown">
                        <a class="nav-link dropdown-toggle text-dark" href="shop.jsp" id="navbarDropdownMenuLink" role="button">Shop</a>
                    ...
                    <li id="about-us-dropdown" class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-dark" href="aboutus.jsp" id="navbarDropdownMenuLink" role="button">About Us
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="contactus.jsp">Contact Us</a>
                    </li>
                    <!-- <li class="nav-item">
                    ...
                    <li id="login-dropdown" class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="success.jsp" id="navbarDropdownMenuLink" role="button" style="color: black;">
