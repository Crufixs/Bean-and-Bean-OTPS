    ...
    <header class="flex-wrap align-items-center justify-content-center justify-content-md-between py-2 mb-3 accent-color">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a href="admin.jsp" class="d-flex align-items-center col-md-5 mb-2 mb-md-0 text-white text-decoration-none">
                ...
                <div id="login-dropdown" class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="success.jsp" id="navbarDropdownMenuLink" role="button" style="color: white; margin-right: 100px;">
                    ...
                    <ul id="login-dropdown-menu" class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li>
                            <form method="POST" action="Logout">
                                <a class="dropdown-item text-white" type="submit">Logout</a>
