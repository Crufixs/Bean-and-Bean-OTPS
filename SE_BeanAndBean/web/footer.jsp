<footer class="page-footer font-small blue pt-4 accent-color">
    <!-- Footer Links -->
        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-md-0 mb-3">
                ...
                <div class="text-center">
                    <a href="https://www.facebook.com/BeanAndBeanCoffee"><svg style="
                                                                              height: 30px;
                                                                              width: 30px;
                    ...
                    <a href="https://www.instagram.com/beanandbeancoffee/"><svg style="
                                                                                height: 30px;
                                                                                width: 30px;
...
<script type="text/javascript" src="imported/jquery.ph-locations-v1.0.0.js"></script>
<script type="text/javascript">
    $('#about-us-dropdown').hover(function () {
        $('#about-us-dropdown-menu').addClass('show')
    }, function () {
