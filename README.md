...
## Demonstration
For demonstration, the website was hosted using Heroku's free website hosting which can be accessed through this <a href="https://bean-and-bean.herokuapp.com/home.jsp">link</a>. Although the website seems functional, there may still be bugs as a result of changing the codes for the ewbsite hosting. 
